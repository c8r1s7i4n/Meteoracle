 ...
 *  - BIP-39 <br>
 *  - BIP-44 <br> <br>
 * According to: https://docs.iota.org/developer/cryptography/transaction-auth/keys-addresses
 */
public class Wallet {
        ...
        protected void setRawPrivKey(String bech32Key) {
            ...
            try {
                ...
                if (hexOutput.startsWith("00")) {
                    // Decode the string (which is already 00-stripped) back into the original binary bytes
